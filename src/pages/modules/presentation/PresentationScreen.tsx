...
const PresentationScreen: React.FC = () => {
  ...
  return (
    <PageWrapperCustom>
      <div
        className={`flex flex-col md:flex-row mx-4 ${isDarkTheme
      ...
      >
        ...
        <div className="flex flex-1 flex-col justify-center space-y-4 order-2 md:order-1 p-4">
          ...
          <div className="flex items-start">
            ...
            >
              <a href="https://drive.google.com/file/d/1sQeb7bWDa3wCWM6sOFZXA56s8GF6O_Cb/view?usp=sharing"
                target="_blank"
                rel="noopener noreferrer"
              >
                {translations['presentation.download_cv']}</a>
            </button>
          </div>
        </div>
      </div>
